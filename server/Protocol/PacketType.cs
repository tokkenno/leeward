...
namespace Leeward.Protocol
{
    internal enum PacketType : uint
    {
        ...
        RequestSetZoneData = 20,         // 0x00000014
        RequestZoneList = 21,            // 0x00000015
        ...
        ResponseJoiningZone = 27,        // 0x0000001B
        ResponseJoinZone = 28,           // 0x0000001C
        ResponseLeaveZone = 29,          // 0x0000001D
        ...
        ResponseSetZoneData = 36,        // 0x00000024
        ResponseZoneList = 37,           // 0x00000025
        ...
        RequestDeleteZone = 56,          // 0x00000038
        ...
        RequestLockZone = 74,            // 0x0000004A
        ResponseLockZone = 75,           // 0x0000004B
